...
from agentdojo.token_usage import add_token_usage, estimate_tokens_from_messages, estimate_tokens_from_text
...
class LocalLLM(BasePipelineElement):
    ...
    def query(
        ...
        add_token_usage(extra_args, input_tokens=input_tokens, output_tokens=output_tokens, approximate=True)
