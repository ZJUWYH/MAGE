# python -m agentdojo.attacks.long_horizon_rewrite --attack-method long_horizon
...
if __name__ == "__main__":
    ...
    import json
    runs_path = _find_repo_root() / "runs" / "gpt-4o-mini-2024-07-18" / args.suite / args.user_task_id / args.attack_method / f"{args.injection_task_id}.json"
